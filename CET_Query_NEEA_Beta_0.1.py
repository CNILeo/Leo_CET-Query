...
while 1:
    ...
    try:
        ...
        print '提交准考证超时，如多次超时请检查网络'
        continue
    try:
        result = response.read().decode('utf-8')
    except:
        print '获取查询结果超时，如多次超时请检查网络'
        continue
